...
def load_data():
    # Jalur langsung membaca file .csv di folder utama GitHub Anda
...
# Validasi Filter Rentang Tanggal
...
# Filter Data Berdasarkan Pilihan Emiten dan Tanggal
...
with tab2:
    ...
    # Menampilkan Tabel Evaluasi Nilai Eror (RMSE, MAE, MAPE)
    ...
    # Visualisasi Bar Chart Perbandingan MAPE untuk Kebutuhan Bab 4 Tesis
